  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'app-scrollbar z-50 min-w-[8rem] max-h-[320px] overflow-y-auto rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-md outline-none',
...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      className={cn(
        'relative flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-none select-none transition-colors',
        'focus:bg-muted focus:text-foreground data-[state=checked]:bg-muted data-[state=checked]:font-medium',
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        'flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none select-none focus:bg-muted data-[inset=true]:pl-8',
        className
      )}
      {...props}
    >
      {children}
      {hideChevron ? null : <ChevronRight className="ml-auto size-4" />}
    </DropdownMenuPrimitive.SubTrigger>
  )
}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        'app-scrollbar z-50 min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-lg outline-none',
        className
      )}
      {...props}
    />
